...
public class AddFlightController {
    ...
    private void handleAddFlight(ActionEvent actionEvent) {
        ...
        DatePicker departureDatePicker = view.getDepartureTimeField();
        Ti
        LocalDateTime departureDateTime = departureDatePicker.getValue(); // convert DatePicker obj to LocalDate
        DatePicker arrivalDatePicker = view.getArrivalTimeField();
        LocalDateTime arrivalDateTime = arrivalDatePicker.getValue();
